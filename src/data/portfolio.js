...
export const projectsData = [
  ...
  },
  {
    ...
    year: '2025',
    impact: '35 anomalies detected · 5-model ensemble · multi-detector overlap analysis',
    description: 'Automated platform replacing manual KPI monitoring. Modular ML pipeline with 5-model anomaly detection ensemble — Isolation Forest, One-Class SVM, LOF, IQR, and Z-score — detecting 35 anomalies with cross-detector overlap analysis. Built with Python, Scikit-learn, Streamlit, and FastAPI.',
